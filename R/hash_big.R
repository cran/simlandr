...
#'
#' `hash_big.matrix` class is a modified class from [bigmemory::big.matrix-class()]. Its purpose is to
...
#' Comparing with [bigmemory::big.matrix-class()], the major enhancement of `hash_big.matrix` class
#' is that the backing files are, by default, stored in a permanent place, with the md5 of the object as the file
#' name. With this explicit name, `hash_big.matrix` objects can be easily reloaded into workspace every time.
#'
#'
#'
#' @import bigmemory
...
#' @describeIn hash_big.matrix-class Create a `hash_big.matrix` object from a matrix.
#' @export
...
#' @describeIn hash_big.matrix-class Attach a `hash_big.matrix` object from the backing file to the workspace.
#' @export
